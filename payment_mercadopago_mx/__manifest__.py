...
{
    'name': 'MercadoPago México Payment Acquirer',
    'category': 'Accounting/Payment Acquirers',
    'sequence': 365,
    'summary': 'Payment Acquirer: MercadoPago México Implementation',
    'version': '15.1.22.1',
    'description': """MercadoPago México Payment Acquirer""",
    ...
    'images': ['src/img/mercadopago_icon.png','src/img/mercadopago_logo.png',
                ...
                'static/description/payment_mercadopago_mx_screenshot.png','static/description/main_screenshot.png',
